...
{
    public function sendImpressionEvent($config, $experimentKey, $variationKey, $flagKey, $flagType, $userId, $attributes)
    {
        parent::sendImpressionEvent($config, $experimentKey, $variationKey, $flagKey, $flagType, $userId, $attributes);
    }
