...
// We also thought that the prefix 'optly' makes it apparent to users that the variable belongs to Optimizely.
define("RESERVED_ATTRIBUTE_KEY_BUCKETING_ID",     "$optly_bucketing_id");
